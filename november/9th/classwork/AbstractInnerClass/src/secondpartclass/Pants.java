...
public class Pants extends Clothes {
    private static final String PUT_ON_MESSAGE = "Pants is on";
    private static final String TAKE_OFF_MESSAGE = "Pants off";
    private static final String PUT_ON_MESSAGE_ERROR = "Pants could not be put on";
    private static final String TAKE_OFF_MESSAGE_ERROR = "Pants could not be take off";
    private static final String PUT_ON_GREETINGS = "Try to pun on a pants";
    private static final String TAKE_OFF_GREETINGS = "Try to take off a pants";

    public Pants(boolean isPutOn) {
        super(isPutOn);
    }
